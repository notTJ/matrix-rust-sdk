...
impl OlmMachine {
    ...
    // ) -> Result<Self, OlmMachine> { // napi::Result<OlmMachine> {
    ...
    // ) -> Result<Self, String> { // napi::Result<String> {
    ...
    //     response: String,
    // ) -> Result<Self, bool> { // napi::Result<bool> {
    ...
    // ) -> Result<Self, Option<requests::KeysClaimRequest>> { // napi::Result<Option<requests::KeysClaimRequest>> {
    //     match self
    //         .inner
    ...
    //     event: String,
    //     room_id: &identifiers::RoomId,
    // ) -> Result<Self, responses::DecryptedRoomEvent> { // napi::Result<responses::DecryptedRoomEvent> {
